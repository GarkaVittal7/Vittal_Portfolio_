  ...
  const projects = [
    {
      ...
      description: "Full-featured dental care platform with role-based login, patient management, appointment scheduling, and treatment tracking.",
      image: "https://images.unsplash.com/photo-1609840114035-3c981a782a6e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400",
    ...
    },
    {
      ...
      description: "Comprehensive banking system for user registration, account operations, and secure transaction handling with robust backend functionality.",
    ...
    },
    {
      ...
      description: "AI-powered automated inspection system using drone technologies and computer vision for real-time monitoring and defect detection in solar plants.",
