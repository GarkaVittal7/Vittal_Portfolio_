        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white space-y-6">
            ...
            <h2 className="text-xl md:text-2xl mb-6 text-white/90 h-8 animate-fadeIn">
              {displayedText}
              <span className={`inline-block w-0.5 h-6 bg-white ml-1 ${isTyping ? 'animate-pulse' : ''}`}></span>
            </h2>
            ...
            <p className="text-lg text-white/80 mb-8 leading-relaxed animate-slideUp delay-300">
              ...
              Experienced in Java, JavaScript, React, and modern web technologies with 
              a focus on building scalable and user-friendly solutions.
            </p>
          ...
          <div className="relative animate-slideUp delay-300">
            ...
            <div className="relative group">
              ...
              <img 
                ...
                className="relative rounded-2xl shadow-2xl w-full h-auto transform hover:scale-105 transition-all duration-500 animate-float"
              />
